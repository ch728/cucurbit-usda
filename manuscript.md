...
and *C. pepo* subsp. *ovifera* \cite{xanthopoulou_whole-genome_2019}. Evidence points 
...
*ovifera* \cite{lust_italian_2016}. Important morphoptypes of *pepo* 
...
\cite{chomicki_origin_2019}. Where and when domestication occurred for this species is 
also unknown; however it is known that *C. moschata* had an India-Myanmar 
secondary center of origin where the species was further diversified \cite{sun_karyotype_2017}. 
...
to move genes across species \cite{sun_karyotype_2017}. Popular market classes 
...
pumpkins known as Calabaza \cite{ferriol_pumpkin_2008}.
...
competition and can reach well over 1000 Kg \cite{savage_making_2015}. Although this 
...
domestication in Japan/China\cite{nee_domestication_1990, sun_karyotype_2017}.
 ...
 the USDA \textit{Cucurbita} germplasm collections for *C. pepo*, *C. moschata*, 
